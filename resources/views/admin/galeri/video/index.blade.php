...
@section('content')
    <div class="container-fluid">
        ...
        <!-- card -->
        <div class="card shadow mb-4 mx-2 col-8">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Video SD Negeri 023</h6>
            </div>
            <div class="card-body">
                <div class="d-flex">
                    <div class="mb-2">
                    ...
                    @if (count($data) > 0)
                        <div class="mb-2">
                            <a href="{{ route('admin.galeri.video.truncate') }}" class="btn btn-sm btn-outline-danger"
                                data-confirm-delete="true">Reset</a>
                        </div>
                    @endif
                </div>

                <x-galeri.video.create />
                    ...
                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                ...
                                <x-galeri.video.detail :item="$item" />
                                <x-galeri.video.update :item="$item" />
                            @endforeach
                        </tbody>
                    </table>
                </div>
