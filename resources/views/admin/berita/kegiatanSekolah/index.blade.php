...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Berita Kegiatan Sekolah</h1>
        </div>

        <!-- card -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Berita Kegiatan Sekolah SD Negeri 023</h6>
            </div>
            <div class="card-body">
                <div class="mb-2">
                ...
                <x-berita.kegiatan-sekolah.create />
                    ...
                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="mx-1"> 
                                                <a class="btn btn-sm btn-danger deleteBtn"
                                                    data-delete-url="{{ route('admin.berita.kegiatanSekolah.delete', $item->id) }}"><i
                                                        class="fa-solid fa-trash"></i></a>
                                            </div>

                                            {{-- <a href="{{ route('admin.berita.kegiatanSekolah.delete', $item->id) }}"
                                ...
                                <x-berita.kegiatan-sekolah.update :item="$item" />
                            @endforeach
                        </tbody>
                    </table>
                </div>
